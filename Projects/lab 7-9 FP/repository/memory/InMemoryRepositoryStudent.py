...
class InMemoryRepositoryStudent(object):
    ...
    def findOne(self, s):
        """
        Caz favorabil: elementul este chiar primul din lista -> T(n) = 1 -> O(1)
        Caz defavorabil: elementul este ultimul din lista -> T(n) = n -> O(n)
        Caz mediu: poate fi 1, 2, 3 .. n element => numarul de pasi = numarul mediu de iteratii
                                - T(n) = (1+2+3+...+n)/n = (n+1)/2 -> T(n) = n -> O(n)
